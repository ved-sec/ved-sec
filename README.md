...
- **Languages & Frameworks:** Python 3.11+, Pydantic v2, httpx, Typer, Bash, PowerShell
- **Security & Cloud Infrastructure:** AWS (VPC, IAM, Lambda, CloudTrail), Terraform (IaC), Linux, Docker
- **Detection & Operations:** Threat Hunting, OSINT Automation, MITRE ATT&CK, SIEM / EDR, Sigma Rules
- **Quality Assurance & CI/CD:** Pytest, Ruff, Mypy, GitHub Actions
...
- **Email:** vedantranganathan46@gmail.com
